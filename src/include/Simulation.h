...
public:
	...
	Eigen::Matrix<unsigned char, Eigen::Dynamic, Eigen::Dynamic> CaptureViewR;
	Eigen::Matrix<unsigned char, Eigen::Dynamic, Eigen::Dynamic> CaptureViewG;
	Eigen::Matrix<unsigned char, Eigen::Dynamic, Eigen::Dynamic> CaptureViewB;
	Eigen::Matrix<unsigned char, Eigen::Dynamic, Eigen::Dynamic> CaptureViewA;

	double m_dt_capture = 0.0333;         //Time between frames in outputs
	double m_capture_time = 0.0;       //Reset to 0 + rest every time we capture
	size_t img_num = 0;
	size_t img_max = 0;
